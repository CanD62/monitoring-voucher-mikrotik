...
<table class="voucher" style=" width: 302px;">
  <tbody>
    <tr>
...
<?php if($usermode == "vc"){?>
        <tr>
          <td style="border: 1px solid black; font-weight:bold;  font-size: 20px;">Kode Voucher</td>
        </tr>
        <tr style="color: black; font-size: 70px;">
          <td style="width:100%; border: 1px solid black; font-weight:bold;"><?php echo $username;?></td>
        </tr>
        <tr>
          <td colspan="2" style="border: 1px solid black; font-weight:bold;  font-size: 20px;"><?php echo $validity;?> <?php echo $timelimit;?> <?php echo $datalimit;?> <?php echo $price;?></td>
        </tr>
<!-- /  -->
<!-- Username & Password  -->
